...
describe('isAlpha', () => {
  ...
  it('16. should throw TypeError when str is not a string', () => {
    expect(() => isAlpha(null as unknown as string)).toThrow(TypeError);
    expect(() => isAlpha(null as unknown as string)).toThrow(
  ...
  it('17. should throw TypeError when str is a number', () => {
    expect(() => isAlpha(123 as unknown as string)).toThrow(TypeError);
    expect(() => isAlpha(123 as unknown as string)).toThrow(
