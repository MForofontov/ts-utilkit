...
describe('isAlphanumeric', () => {
  ...
  it('16. should throw TypeError when str is not a string', () => {
    expect(() => isAlphanumeric(null as unknown as string)).toThrow(TypeError);
    expect(() => isAlphanumeric(null as unknown as string)).toThrow(
  ...
  it('17. should throw TypeError when str is a number', () => {
    expect(() => isAlphanumeric(123 as unknown as string)).toThrow(TypeError);
    expect(() => isAlphanumeric(123 as unknown as string)).toThrow(
