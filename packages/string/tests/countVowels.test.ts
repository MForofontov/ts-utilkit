...
describe('countVowels', () => {
  ...
  it('16. should throw TypeError when str is not a string', () => {
    expect(() => countVowels(null as unknown as string)).toThrow(TypeError);
    expect(() => countVowels(null as unknown as string)).toThrow(
  ...
  it('17. should throw TypeError when str is a number', () => {
    expect(() => countVowels(123 as unknown as string)).toThrow(TypeError);
    expect(() => countVowels(123 as unknown as string)).toThrow(
