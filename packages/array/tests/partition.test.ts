...
describe('partition', () => {
  ...
  it('14. should throw TypeError when arr is not an array', () => {
    expect(() => partition('not an array' as unknown as string[], (x) => !!x)).toThrow(TypeError);
    expect(() => partition('not an array' as unknown as string[], (x) => !!x)).toThrow(
  ...
  it('15. should throw TypeError when arr is null', () => {
    expect(() => partition(null as unknown as never[], (x) => !!x)).toThrow(TypeError);
    expect(() => partition(null as unknown as never[], (x) => !!x)).toThrow(
  ...
  it('16. should throw TypeError when predicate is not a function', () => {
    expect(() => partition([1, 2, 3], 'not a function' as unknown as () => boolean)).toThrow(TypeError);
    expect(() => partition([1, 2, 3], 'not a function' as unknown as () => boolean)).toThrow(
      'predicate must be a function, got string',
    );
  });
});
