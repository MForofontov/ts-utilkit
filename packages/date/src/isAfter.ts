/**
 * Returns `true` if `date1` is strictly after `date2` (millisecond precision).
 *
 ...
 * @example
 * // date1 is later
 * isAfter(new Date('2025-06-01'), new Date('2025-01-01')); // true
 *
 * @example
 * // date1 is earlier
 * isAfter(new Date('2025-01-01'), new Date('2025-06-01')); // false
 *
 * @example
 * // Identical dates
 ...
 * isAfter(new Date('2025-01-01T12:00:00'), new Date('2025-01-01T08:00:00')); // true
 *
